...
public class ClientRMIReceiver extends UnicastRemoteObject implements ClientRMIInterface {
    ...
    public void sendFirstPlayerTurn(int lastPlayerID, int playerID, int[] playerIDs, int[] starterCardIDs,
        ...
        view.showFirstPlayerTurn(lastPlayerID, playerID, playerIDs, starterCardIDs, starterCardSides, tokenColors, playerHands);
    }
    ...
    @Override
    public void sendReAfterSetup(int playerID, Map<Integer, String> IDToNicknameMap, int[] gameSetupCards, CardSideType starterSide, TokenColors tokenColor) throws RemoteException {
        view.reconnectAfterSetup(playerID, IDToNicknameMap, gameSetupCards, starterSide, tokenColor);
    }
