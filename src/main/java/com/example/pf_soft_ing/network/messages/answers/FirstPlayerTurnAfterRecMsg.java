...
public class FirstPlayerTurnAfterRecMsg extends Message {
    ...
    public FirstPlayerTurnAfterRecMsg(int playerID, int[] playerIDs, int[] starterCardIDs, CardSideType[] starterCardSides, TokenColors[] tokenColors, int[][] playerHands, int resDeckCardID, int visibleResCardID1, int visibleResCardID2, int goldDeckCardID, int visibleGoldCardID1, int visibleGoldCardID2) {
    ...
    public String toString() {
        return "FirstPlayerTurnAfterRecMsg{}";
    }
}
